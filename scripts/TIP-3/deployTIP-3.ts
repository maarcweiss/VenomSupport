...
async function main() {
  ...
  const initialSupplyTo = new Address("0:b67cebc6579c98b283e33cbbd07d7e88fab023e1f52e2f2d62c2cc9c9321def8");
  // Address of token owner (write your own)
  const rootOwner = new Address("0:b67cebc6579c98b283e33cbbd07d7e88fab023e1f52e2f2d62c2cc9c9321def8");
  // Name of the token
  const name = "Venom Verse Token";
  // Symbol of the token
  const symbol = "Venom Verse";
